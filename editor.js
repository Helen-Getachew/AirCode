  ...
  wrapper.innerHTML = `
    ...
    <div style="display:flex;gap:8px;padding:12px 16px;border-bottom:1px solid var(--border);overflow-x:auto">
      ${['html','css','javascript','python'].map(lang => `
        <button class="lang-btn ${lang === language ? 'lang-active' : ''}"
          ...
          background:${lang === language ? 'linear-gradient(135deg,#2563eb,#1d4ed8)' : 'var(--surface2)'};
    ...
    <div style="flex:1;display:flex;flex-direction:column;min-height:0">
      ...
      <textarea id="code-editor"
        ...
        autocorrect="off"
        autocapitalize="off"
        style="flex:1;padding:16px;background:#07111f;color:#d9e8ff;font-family:'Courier New',monospace;
    ...
    <div style="padding:12px 16px;background:var(--surface);border-top:1px solid var(--border);border-bottom:1px solid var(--border)">
      <button id="btn-run" style="width:100%;padding:13px;background:linear-gradient(135deg,#2563eb,#1d4ed8);
    ...
    <div style="flex:1;min-height:200px;display:flex;flex-direction:column">
      ...
      <div id="output-console"
        style="flex:1;padding:16px;background:#07111f;color:#34d399;font-family:'Courier New',monospace;
    ...
    <head>
      <style>
        body { font-family: 'Courier New', monospace; font-size: 14px;
               background: #07111f; color: #34d399; padding: 16px; line-height: 1.7; }
        .error { color: #f87171; }
      </style>
    </head>
    <body>
